import { Button, Group, Header, MediaQuery, Text, Image, Select, Space, Input, Autocomplete, Title } from "@mantine/core";
...
export default function VodViewHeader({ searchParameters, setsearchParameters, nameList, nameFilter, setNameFilter, pageTitle}: VodViewHeaderProps) {
